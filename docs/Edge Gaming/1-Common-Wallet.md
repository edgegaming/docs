...
| bet_info     | string | Betting info(opponent's name)<b>下注信息（对手姓名）                                                  |
| bet_value    | string | Betting value<b>下注值                                                                  |
...
| winner       | string | Info of the winner(name of the winner)<b>获奖者信息（获奖者姓名） |
